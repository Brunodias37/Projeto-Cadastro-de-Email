...
eMail=['tulio.felipe@hotmail.com','joao.silva@gmail.com', 'mariafilo@yahoo.com', 'carlos.silva@gmail.com','sansou@hotmail.com.br']
...
def imprimir():
    dados = pd.DataFrame(eMail, pd.Categorical(nomeCompleto))
    print(dados)
    print("Deseja exportar este conteudo para uma planilha Excel")
    print("[1]-Sim")
    print("[2]-Não")
    resposta = int(input())
    if(resposta == 1):
